...
<body><!-------------------reg-------------------------->
<div class="reg">
    <form action="User/reg" id="regForm" method="post" onsubmit="return checkForm(this)"><h1><a href="index.html"><!--  img src="学习猿地"--></a></h1>
        ...
        <p><label for="passWord"></label><input type="password" id="passWord" name="passWord" placeholder="密码"><span></span></p>
        <p><label for="rePassWord"></label><input type="password" id="rePassWord" name="rePassWord" placeholder="确认密码"><span></span></p>
        <p>
            <label>
        ...
        <p>
            <label for="birthday"></label><input type="date" id="birthday" name="birthday" placeholder="生日"><span></span> </p>
        <p><label for="email"></label><input type="text" id="email" name="email" placeholder="邮箱" required><span></span></p>
        <p><label for="mobile"></label><input type="text" id="mobile" name="mobile" placeholder="电话号码" required><span></span></p>
        <p><input type="text" id="address" name="address" placeholder="地址"><span></span></p>
        <p><label>
            <input class="code" type="text" name="code" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="验证码">
        </label>
